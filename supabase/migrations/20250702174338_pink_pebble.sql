/*
  ...
  2. Security
    ...
    - Add policy for candidates to insert applications
    - Add policy for recruiters to update application status
    - Add unique constraint on job_id and candidate_id
*/
